...
public class No2 {
    ...
    if (
     ...
     (  "A".equals(nilaiInterview) || nilaiInterview == "B")
        ...
        System.out.println("Selamat Kamu Berhasil Menjadi mahasiswa teknik informatika");
    } else {
        System.out.println("Maaf kamu masih dipertimbangkan umtuk jadi mahasiswa teknik informatika");
    }
